...
def generate_frequency(hfilepath, outpath="Omega", N=10, no_save=True, no_show=True):
  #open the file
  f=h5py.File(hfilepath,'r')
...
if __name__ == "__main__": 
    ...
    generate_frequency(opts.input, opts.output, opts.n, 
                       no_save=opt.no_save)
